...
if __name__ == '__main__':
    ...
    with SyncCrazyflie(URI, cf=Crazyflie(rw_cache='./cache')) as scf:
        acconf = LogConfig(name='acceleration', period_in_ms=TIME_INTERVAL)
        ...
        # posconf = LogConfig(name='position', period_in_ms=TIME_INTERVAL)
        ...
        batconf = LogConfig(name='battery', period_in_ms=TIME_INTERVAL)
